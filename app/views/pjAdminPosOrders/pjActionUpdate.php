    ...
    <div class="row">
      ...
      <div class="col-sm-12 bg-blue-secondary topnav-two">
        <div class="row" style="margin-top: 5px;margin-bottom: 5px;">
          ...
          <div id="page_navigation" class="col-sm-4" style="text-align: right;">
          </div>
        </div> 
      </div>
      <div class="col-sm-12 bg-blue-secondary" style="min-height: 700px;">
        ...
        <div id="products-sec" class="row products" style="display: none;">
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-7 bg-light" id="col-7">
    <div class="col-sm-12">
      <div style="float: right;">
        ...
        <?php } else { ?>
        <span class="dis-confirm-table-btn">
          <?php echo  substr($tpl['arr']['origin'], 0, 3)." - ". ucfirst(substr($tpl['arr']['type'], 0, 1)); ?>
        </span>
        <?php } ?>
      ...
      <?php 
        if (strtolower($tpl['arr']['origin']) == "telephone" || (strtolower($tpl['arr']['origin']) == "web" )) { 
          include PJ_VIEWS_PATH . 'pjAdminPosOrders/elements/order_form_telephone_update.php';
        } elseif ($tpl['arr']['origin'] == "Pos") { 
          include PJ_VIEWS_PATH . 'pjAdminPosOrders/elements/order_form_pos_eatin_update.php';
        } 
      ?>
  </div><!-- /.col-sm-6 -->
</div>
