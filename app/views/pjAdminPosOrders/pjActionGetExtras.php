...
<tr>
    <td>
        <select name="extra_id[<?php echo $index; ?>][<?php echo $extra_index; ?>]" data-index="<?php echo $index; ?>_<?php echo $extra_index; ?>" class="fdExtra fdExtra_<?php echo $index; ?> form-control" id="fdExtra_<?php echo $index; ?>">
