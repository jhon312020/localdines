                        ...
                        <div class="row m-b-md">
    						...
    						<div class="col-md-3">
    							...
    							<div class="form-group m-b-md">
    								<a id="pjFdPrintReprot" href="#" data-href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminReports&amp;action=pjActionPOSZPrint" class="btn btn-primary btn-outline"><i class="fa fa-print"></i> <?php __('btnPrint');?></a>
    							</div>
    						</div>
                        </div><!-- /.row -->
                    </form>
