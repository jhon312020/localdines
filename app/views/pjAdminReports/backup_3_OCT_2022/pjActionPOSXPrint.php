          ...
          <div class="pos-report">
            ...
            <table class="table" style="margin: auto; text-align: center;">
              ...
              <tr>
                ...
                <td><?php echo pjCurrency::formatPrice($tpl['sales_report']['total_table_sales']); ?></td>
              </tr>
              <tr>
                ...
                <td><?php echo pjCurrency::formatPrice($tpl['sales_report']['total_direct_sales']); ?></td>
              </tr>
              <tr>
                <th><?php echo "No of Sales: ";?></th>
                <td><?php echo $tpl['num_of_sales']; ?></td>
                <th><?php echo "Total Sales: ";?></th>
                <td><?php echo pjCurrency::formatPrice($tpl['sales_report']['total_amount']); ?></td>
              </tr>
            </table>       
          </div>
        </div>
