  ...
  <div class="col-sm-12">
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12">
        <h2>Expense Orders<?php //echo $tpl['loadData'];//__('infoExtrasTitle');?></h2>
      </div>
    </div><!-- /.row -->
  </div><!-- /.col-md-12 -->
</div>
    ...
    <div class="ibox float-e-margins">
      <div class="ibox-content">
        <div class="row">
          <div class="col-md-4">
            <select name="type" id="filter_reports2" class="form-control">
              ...
              <option <?php if($tpl['loadData'] == "Expense") { echo "selected";} ?> value="expense-Report">Expense Reports</option>
        ...
        <div class="row" id="pos-grid-header">
          <input id="gridTypeExpense" type="hidden" name="type" value="ER">
          <div id="overAllExpenseTotal" class="col-md-6 text-right">
           <?php $overAllExpenseTotal = $response['overAllExpenseTotal'] ?? ''; ?>
            <h1>Total - <span><?php echo $tpl['overAllExpenseTotal']; ?></span></h1>
          </div>
        </div><!-- /.row -->
...
<script type="text/javascript">
  ...
  myLabel.expense_date = '<?php echo 'Date'; ?>';
