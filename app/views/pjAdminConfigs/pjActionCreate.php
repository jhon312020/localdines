  ...
  <div class="col-sm-12">
    <div class="row">
      <div class="col-lg-9 col-md-8 col-sm-6">
        <h2>  Add new Config<?php //__('infoAddProductTitle');?></h2>
      </div>
    </div><!-- /.row -->
  </div><!-- /.col-md-12 -->
</div> 
  ...
  <div class="col-sm-12 col-lg-offset-3 col-lg-6 ">
    <div class="ibox float-e-margins">
      <div class="ibox-content">
        <form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminConfigs&amp;action=pjActionCreate" method="post" id="frmCreateConfig" autocomplete="off">
          <?php
