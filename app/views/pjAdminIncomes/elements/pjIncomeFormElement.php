<div class="row">
  <div class="col-sm-12 col-lg-12">
    ...
    <div class="form-group">
      <label class="control-label">Patner Name</label>
    ...
    <div class="form-group">
      ...
      <input type="text" name="amount" id="amount" value="<?php echo array_key_exists('arr', $tpl) && $tpl['arr']['amount'] ? $tpl['arr']['amount'] : '' ?>" class="form-control required amount" data-msg-required="This field is required." />
    </div><!-- /.form-group -->
