            ...
            <div class="ibox float-e-margins">
                <div class="ibox-content ibox-heading clearfix">
                    ...
                    <div class="pull-right m-t-md">
                    	<a class="btn btn-primary btn-sm btn-outline m-n" href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOrders&amp;action=pjActionIndex&amp;type=delivery"><?php __('lblViewAll');?></a>
                    </div><!-- /.pull-right -->
                </div>
        ...
        <div class="col-lg-4">
            <div class="ibox float-e-margins">
                <div class="ibox-content ibox-heading clearfix">
                    ...
                    <div class="pull-right m-t-md">
                    	<a class="btn btn-primary btn-sm btn-outline m-n" href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOrders&amp;action=pjActionIndex&amp;type=pickup"><?php __('lblViewAll');?></a>
                    </div><!-- /.pull-right -->
                </div>
