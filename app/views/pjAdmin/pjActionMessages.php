...
if (jQuery_1_8_2.datagrid !== undefined) {
	jQuery_1_8_2.extend(jQuery_1_8_2.datagrid.messages, {
		...
		total_prefix: "<?php __('gridTotalPrefix'); ?>",
		total_suffix: "<?php __('gridTotalSuffix'); ?>",
		show: "<?php __('gridShow'); ?>",
		...
		empty_date: "<?php __('gridEmptyDate'); ?>",
		invalid_date: "<?php __('gridInvalidDate'); ?>"
	});
}
