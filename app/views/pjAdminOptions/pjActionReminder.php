									...
									<div class="col-lg-9 col-md-8">
										...
										foreach ($tpl['lp_arr'] as $v)
										{
											...
											<div class="pj-multilang-wrap<?php echo $tpl['is_flag_ready'] ? ' input-group' : NULL;?>" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
												<input type="text" name="i18n[<?php echo $v['id']; ?>][o_reminder_subject]" class="form-control" value="<?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']]['o_reminder_subject'])); ?>" />
												<?php if ($tpl['is_flag_ready']) : ?>
								...
								<div class="form-group boxReminder">
									...
									<div class="col-lg-9 col-md-8 mce-md">
										...
										foreach ($tpl['lp_arr'] as $v)
										{
											?>
											<div class="pj-multilang-wrap<?php echo $tpl['is_flag_ready'] ? ' input-group' : NULL;?>" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 0 ? 'none' : NULL; ?>">
												<textarea name="i18n[<?php echo $v['id']; ?>][o_reminder_body]" class="form-control mceEditor" style="width: 400px; height: 260px;"><?php echo htmlspecialchars(stripslashes(@$tpl['arr']['i18n'][$v['id']]['o_reminder_body'])); ?></textarea>
												<?php if ($tpl['is_flag_ready']) : ?>
												<span class="input-group-addon pj-multilang-input"><img src="<?php echo PJ_INSTALL_URL . PJ_FRAMEWORK_LIBS_PATH . 'pj/img/flags/' . $v['file']; ?>" alt="<?php echo pjSanitize::html($v['name']); ?>"></span>
												<?php endif; ?>
											</div>
