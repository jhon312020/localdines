    ...
    <div class="col-sm-12">
        <div class="row">
        	<div class="col-lg-9 col-md-8 col-sm-6">
                <h2><?php echo "Special Instruction Types";?></h2>
            </div>
        ...
        <p class="m-b-none"><i class="fa fa-info-circle"></i> <?php echo "Below is a list of all special instruction types added to the system. Use the tab above to add new special instruction or edit one by clicking on the pencil icon of each row. You can organize special instructions with drag & drop.";?></p>
    </div><!-- /.col-md-12 -->
</div>
    ...
    <div class="col-lg-8">
        <div class="ibox float-e-margins">
            <div class="ibox-content">
                <div class="row">
                	<div class="col-md-4">
                    	<a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminSpecialInstructions&action=pjActionIndex" class="btn btn-primary"><i class="fa fa-eye"></i> <?php echo "View Spcl Ins" ?></a>
                        <a href="#" class="btn btn-primary pjFdAddType"><i class="fa fa-plus"></i> <?php echo "Add Type" ?></a>
                    </div><!-- /.col-md-6 -->
                ...
                <div id="grid-types"></div>
                
            </div>
        </div>
    </div><!-- /.col-lg-8 -->
    <div class="col-lg-4">
        <div id="pjFdFormTypeWrapper" class="panel no-borders">
